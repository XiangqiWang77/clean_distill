...
def main() -> None:
    ...
    ax.annotate("3.50-pp observed band", xy=(0.011, 68.1), color=blue, fontsize=8, ha="center")
    ...
    ax.axhline(75, color=orange, linewidth=0.9, linestyle=(0, (2, 2)), alpha=0.65)
    ...
    ax.annotate("selected point", xy=(0.004, 69.3037), xytext=(0.00115, 86), fontsize=7.8, color=gray, arrowprops={"arrowstyle": "->", "color": gray, "lw": 0.8})
    ax.set_title("C. Target-retention transition")
    ...
    figure.suptitle("TRSD epsilon calibrates locality across a narrow observed accuracy band", x=0.055, ha="left", y=0.96, fontsize=16, fontweight="bold", color="#202733")
