#!/usr/bin/env python3
"""Download the released TRSD/OPSD PEFT adapters directly from GitHub."""
...
def main() -> None:
    ...
    parser.add_argument("--method", choices=("trsd", "opsd", "all"), required=True)
    ...
    methods = ("trsd", "opsd") if args.method == "all" else (args.method,)
